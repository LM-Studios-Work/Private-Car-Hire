  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <a
        ...
        className="group fixed bottom-6 right-6 z-50 bg-[#25D366] hover:bg-[#20BA5A] text-white w-16 h-16 rounded-full flex items-center justify-center shadow-2xl transition-all hover:scale-110 hover:rotate-3 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-[#A4C639] focus-visible:ring-offset-2 focus-visible:ring-offset-white"
      >
        {/* Tooltip for desktop hover and keyboard focus */}
        <span className="absolute right-full mr-4 top-1/2 -translate-y-1/2 px-3 py-2 bg-gray-900 text-white text-sm rounded-lg opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity whitespace-nowrap pointer-events-none shadow-lg">
          Chat on WhatsApp
        </span>
