        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              ...
              from quick city rides to long-distance travel and specialized
              errands.
            </p>
          </div>
              ...
              <CardContent className="p-6 flex flex-col flex-grow justify-between">
                <div className="mb-4">
                  ...
                  <p className="text-gray-600">
                    ...
                    fuel-efficient vehicles for your personal or business use.
                  </p>
                </div>
            ...
            <Card className="overflow-hidden hover:shadow-xl transition-shadow rounded-3xl border-0 h-full flex flex-col">
              ...
              <CardContent className="p-6 flex flex-col flex-grow justify-between">
                <div className="mb-4">
                  ...
                  <p className="text-gray-600">
                    Reliable on-time airport transfers with flight tracking to
                    ensure you're never late.
                  </p>
                </div>
            ...
            <Card className="overflow-hidden hover:shadow-xl transition-shadow rounded-3xl border-0 h-full flex flex-col">
              ...
              <CardContent className="p-6 flex flex-col flex-grow justify-between">
                <div className="mb-4">
                  ...
                  <p className="text-gray-600">
                    Safe and dependable transport for your children, with vetted
                    drivers and scheduled pickups.
                  </p>
                </div>
            ...
            <Card className="overflow-hidden hover:shadow-xl transition-shadow rounded-3xl border-0 h-full flex flex-col">
              ...
              <CardContent className="p-6 flex flex-col flex-grow justify-between">
                <div className="mb-4">
                  ...
                  <p className="text-gray-600">
                    Quick and secure package delivery across the city for your
            ...
            <Card className="overflow-hidden hover:shadow-xl transition-shadow rounded-3xl border-0 h-full flex flex-col">
              ...
              <CardContent className="p-6 flex flex-col flex-grow justify-between">
                <div className="mb-4">
                  ...
                  <p className="text-gray-600">
                    Let us handle your city errands, from document delivery to
                    personal shopping.
                  </p>
                </div>
