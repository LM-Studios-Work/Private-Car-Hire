              ...
              {servicesDropdownOpen && (
                <div className="absolute top-full left-0 mt-0 bg-white shadow-lg rounded-xl py-2 min-w-[200px] border border-gray-100">
                  <Link
                    ...
                    className="block px-4 py-2 hover:bg-gray-50 hover:text-[#A4C639] focus-visible:outline-none focus-visible:bg-gray-50 focus-visible:text-[#A4C639] focus-visible:ring-2 focus-visible:ring-[#A4C639] rounded-md"
                  >
                    Car Hire
                  </Link>
                  <Link
