          ...
          <div className="hidden md:flex gap-8 items-center text-gray-700">
            ...
            >
              <button
                ...
                className="hover:text-[#A4C639] transition-colors font-medium flex items-center gap-1"
              >
            ...
            <Link href="/booking" className="bg-[#A4C639] hover:bg-[#8FB02F] text-white px-6 py-2 rounded-xl">
              Book Online
            </Link>
          </div>
        ...
        <div id="mobile-menu" className="fixed inset-0 z-50 bg-white flex flex-col p-4 md:hidden">
          ...
          <div className="flex flex-col gap-6 text-lg text-gray-700">
            ...
            <Link
              href="/booking"
              onClick={() => setIsMobileMenuOpen(false)}
              className="bg-[#A4C639] hover:bg-[#8FB02F] text-white px-6 py-3 rounded-xl w-full mt-4 text-center block"
            >
              Book Online
            </Link>
          </div>
