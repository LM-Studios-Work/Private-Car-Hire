      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-white/95 backdrop-blur-sm border-b border-gray-200">
        <nav className="flex items-center justify-between max-w-7xl mx-auto px-4 md:px-8 py-4">
          ...
          <div className="hidden md:flex gap-8 items-center text-gray-700">
            ...
            <Link href="/booking" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A4C639] rounded-xl">
              <span className="block bg-[#A4C639] hover:bg-[#8FB02F] text-white px-6 py-2 rounded-xl text-center">
                Book Online
              </span>
            </Link>
          </div>
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 bg-white flex flex-col p-4 md:hidden">
          ...
          <div className="flex flex-col gap-6 text-lg text-gray-700">
            ...
            <Link href="/booking" onClick={() => setIsMobileMenuOpen(false)} className="mt-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A4C639] rounded-xl block">
              <span className="block bg-[#A4C639] hover:bg-[#8FB02F] text-white px-6 py-3 rounded-xl w-full text-center">
                Book Online
              </span>
            </Link>
          </div>
