          ...
          <div className="hidden md:flex gap-8 items-center text-gray-700">
            ...
            >
              ...
              {servicesDropdownOpen && (
                <div id="services-menu-desktop" className="absolute top-full left-0 mt-0 bg-white shadow-lg rounded-xl py-2 min-w-[200px] border border-gray-100">
                  <Link
            ...
            <Link
              href="/booking"
              className="bg-[#A4C639] hover:bg-[#8FB02F] text-white px-6 py-2 rounded-xl focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#A4C639] outline-none inline-block text-center"
            >
              Book Online
            </Link>
          </div>
          ...
          <div className="flex flex-col gap-6 text-lg text-gray-700">
            ...
            <div className="relative">
              <button
                ...
                className="hover:text-[#A4C639] transition-colors font-medium flex items-center gap-1 w-full focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#A4C639] outline-none rounded-md p-1"
                aria-expanded={servicesDropdownOpen}
              ...
              {servicesDropdownOpen && (
                <div id="services-menu-mobile" className="mt-2 pl-4 flex flex-col gap-4">
                  <Link
                    href="/services/car-hire"
                    onClick={() => setIsMobileMenuOpen(false)}
            ...
            <Link
              href="/booking"
              onClick={() => setIsMobileMenuOpen(false)}
              className="bg-[#A4C639] hover:bg-[#8FB02F] text-white px-6 py-3 rounded-xl w-full mt-4 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#A4C639] outline-none block text-center"
            >
              Book Online
            </Link>
          </div>
