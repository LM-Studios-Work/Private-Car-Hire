        ...
        <nav className="flex items-center justify-between max-w-7xl mx-auto px-4 md:px-8 py-4">
          ...
          <div className="hidden md:flex gap-8 items-center text-gray-700">
            ...
            >
              <button
                ...
                className="hover:text-[#A4C639] focus-visible:ring-2 focus-visible:outline-none rounded-sm transition-colors font-medium flex items-center gap-1"
              >
            ...
            <Link
              href="/booking"
              className="bg-[#A4C639] hover:bg-[#8FB02F] text-white px-6 py-2 rounded-xl focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-offset-2"
            >
              <span className="inline-block">Book Online</span>
            </Link>
          </div>
          <div className="md:hidden">
            <button
              ...
              className="focus-visible:ring-2 focus-visible:outline-none rounded-sm"
            >
          ...
          <div className="flex flex-col gap-6 text-lg text-gray-700">
            ...
            <div className="relative">
              <button
                ...
                aria-expanded={servicesDropdownOpen}
                className="hover:text-[#A4C639] transition-colors font-medium flex items-center gap-1 w-full focus-visible:ring-2 focus-visible:outline-none rounded-sm"
              >
                Services{" "}
                <ChevronDown
            ...
            <Link
              href="/booking"
              onClick={() => setIsMobileMenuOpen(false)}
              className="bg-[#A4C639] hover:bg-[#8FB02F] text-white px-6 py-3 rounded-xl w-full mt-4 text-center focus-visible:ring-2 focus-visible:outline-none focus-visible:ring-offset-2"
            >
              <span className="inline-block">Book Online</span>
            </Link>
          </div>
