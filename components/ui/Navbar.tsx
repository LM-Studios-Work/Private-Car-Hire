          ...
          <div className="hidden md:flex gap-8 items-center text-gray-700">
            ...
            >
              <button
                ...
                className="hover:text-[#A4C639] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A4C639] rounded px-2 py-1 -ml-2 transition-colors font-medium flex items-center gap-1"
              >
          ...
          <div className="flex flex-col gap-6 text-lg text-gray-700">
            ...
            <div className="relative">
              <button
                ...
                aria-haspopup="true"
                aria-expanded={servicesDropdownOpen}
                className="hover:text-[#A4C639] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#A4C639] rounded px-2 py-1 -ml-2 transition-colors font-medium flex items-center gap-1 w-full"
              >
                Services{" "}
                <ChevronDown
