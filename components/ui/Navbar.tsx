        ...
        <nav className="flex items-center justify-between max-w-7xl mx-auto px-4 md:px-8 py-4">
          ...
          <div className="md:hidden">
            <button
              ...
              className="focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#A4C639] outline-none rounded-sm p-1"
            >
          ...
          <div className="flex flex-col gap-6 text-lg text-gray-700">
            ...
            <div className="relative">
              <button
                ...
                className="hover:text-[#A4C639] transition-colors font-medium flex items-center gap-1 w-full focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-[#A4C639] outline-none rounded-sm px-1 py-0.5"
                aria-haspopup="true"
                aria-expanded={servicesDropdownOpen}
              >
                Services{" "}
